...
from tau_coding.tui.completion_layout import (
    COMPLETION_MAX_VISIBLE_LINES,
)
from tau_coding.tui.completion_layout import (
    activity_prompt_border_color as _activity_prompt_border_color,
)
from tau_coding.tui.completion_layout import (
    completion_render_line_count as _completion_render_line_count,  # noqa: F401
)
from tau_coding.tui.completion_layout import (
    completion_selected_render_line as _completion_selected_render_line,  # noqa: F401
)
from tau_coding.tui.completion_layout import (
    completion_visible_line_limit as _completion_visible_line_limit,
)
from tau_coding.tui.completion_layout import (
    is_terminal_command_prompt as _is_terminal_command_prompt,
)
from tau_coding.tui.completion_layout import (
    is_user_message_end_event as _is_user_message_end_event,
)
from tau_coding.tui.completion_layout import (
    render_activity_indicator as _render_activity_indicator,
)
from tau_coding.tui.completion_layout import (
    should_optimistically_render_prompt as _should_optimistically_render_prompt,
)
from tau_coding.tui.completion_layout import (
    terminal_command_prefix_span as _terminal_command_prefix_span,
)
from tau_coding.tui.completion_layout import (
    visible_completion_state as _visible_completion_state,
)
